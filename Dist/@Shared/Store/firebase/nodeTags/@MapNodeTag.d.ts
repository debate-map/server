...
export declare function GetTagCompClassByKey(key: string): typeof TagComp_MirrorChildrenFromXToY | typeof TagComp_RestrictMirroringOfX | typeof TagComp_XIsExtendedByY | typeof TagComp_MutuallyExclusiveGroup;
export declare function CalculateTagCompDisplayName(className: string): string;
export declare function GetTagCompClassByDisplayName(displayName: string): typeof TagComp_MirrorChildrenFromXToY | typeof TagComp_RestrictMirroringOfX | typeof TagComp_XIsExtendedByY | typeof TagComp_MutuallyExclusiveGroup;
export declare function GetTagCompClassByTag(tag: MapNodeTag): typeof TagComp_MirrorChildrenFromXToY | typeof TagComp_RestrictMirroringOfX | typeof TagComp_XIsExtendedByY | typeof TagComp_MutuallyExclusiveGroup;
