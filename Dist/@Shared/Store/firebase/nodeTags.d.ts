...
export declare const GetNodeTagComps: ((nodeID: string, unwrapCompositeTags?: boolean, tagsToIgnore?: string[]) => TagComp[]) & {
    Wait: (nodeID: string, unwrapCompositeTags?: boolean, tagsToIgnore?: string[]) => TagComp[];
};
